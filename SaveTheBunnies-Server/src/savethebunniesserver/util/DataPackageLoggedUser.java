...
public class DataPackageLoggedUser implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5773393736771154162L;
	...
	public DataPackageLoggedUser(String username, String name, String password, String email, int lastLevelPassedStory,
			int[] levelsBuilt, int[] levelsPassed, int idImageProfile, java.util.Date dateRegistration, String messageInfo, boolean stateLogin) {
